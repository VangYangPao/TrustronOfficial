...
In order to support loading of multiple wallets in trustron-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is trustron.cpp.
...
Changes to trustron.cpp
----------------------
trustron.cpp is the entry point into trustron-qt, and as such, will require some minor modifications to provide hooks for
