/* src/config/trustron-config.h.  Generated from trustron-config.h.in by configure.  */
/* src/config/trustron-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef TRUSTRON_CONFIG_H

#define TRUSTRON_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.trustron.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Trustron Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Trustron Core 2.1.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "trustron"
