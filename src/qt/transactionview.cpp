                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Trustron from zTrustron"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zTrustron"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zTrustron));
