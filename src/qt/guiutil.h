...
/** Utility functions used by the Trustron Qt UI.
 */
namespace GUIUtil
{
...
// Render Trustron addresses in monospace font
...
// Parse "trustron:" URI into recipient object, return true on successful parsing
