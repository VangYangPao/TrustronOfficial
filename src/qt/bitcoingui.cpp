                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Trustron Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Trustron address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and trustron: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zTSN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Trustron Core"), this);
    aboutAction->setStatusTip(tr("Show information about Trustron Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Trustron"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Trustron addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Trustron addresses"));
    ...
    openAction->setStatusTip(tr("Open a Trustron: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Trustron Core help message to get a list with possible Trustron command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Trustron Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Trustron network", "", count));
}
...
{
    QString strTitle = tr("Trustron Core"); // default title
