...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Trustron Core trustron-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  trustron-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded trustron transaction") + "\n" +
                               "  trustron-tx [options] -create [commands]   " + _("Create hex-encoded trustron transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded trustron transaction
