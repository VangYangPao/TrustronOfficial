...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Trustron server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Trustron server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Trustron features */
        {"trustron", "masternode", &masternode, true, true, false},
        {"trustron", "listmasternodes", &listmasternodes, true, true, false},
        {"trustron", "getmasternodecount", &getmasternodecount, true, true, false},
        {"trustron", "masternodeconnect", &masternodeconnect, true, true, false},
        {"trustron", "masternodecurrent", &masternodecurrent, true, true, false},
        {"trustron", "masternodedebug", &masternodedebug, true, true, false},
        {"trustron", "startmasternode", &startmasternode, true, true, false},
        {"trustron", "createmasternodekey", &createmasternodekey, true, true, false},
        {"trustron", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"trustron", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"trustron", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"trustron", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"trustron", "getmasternodescores", &getmasternodescores, true, true, false},
        {"trustron", "mnbudget", &mnbudget, true, true, false},
        {"trustron", "preparebudget", &preparebudget, true, true, false},
        {"trustron", "submitbudget", &submitbudget, true, true, false},
        {"trustron", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"trustron", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"trustron", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"trustron", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"trustron", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"trustron", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"trustron", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"trustron", "checkbudgets", &checkbudgets, true, true, false},
        {"trustron", "mnsync", &mnsync, true, true, false},
        {"trustron", "spork", &spork, true, true, false},
        {"trustron", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"trustron", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use trustrond, or the -server option to trustron-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> trustron-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:39812/\n";
}
