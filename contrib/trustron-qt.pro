...
RESOURCES += src/qt/trustron.qrc src/qt/trustron_locale.qrc

TRANSLATIONS += src/qt/locale/trustron_bg.ts \
                src/qt/locale/trustron_de.ts \
                src/qt/locale/trustron_en.ts \
                src/qt/locale/trustron_es.ts \
                src/qt/locale/trustron_fi.ts \
                src/qt/locale/trustron_fr.ts \
                src/qt/locale/trustron_it.ts \
                src/qt/locale/trustron_ja.ts \
                src/qt/locale/trustron_pl.ts \
                src/qt/locale/trustron_pt.ts \
                src/qt/locale/trustron_ru.ts \
                src/qt/locale/trustron_sk.ts \
                src/qt/locale/trustron_sv.ts \
                src/qt/locale/trustron_vi.ts \
                src/qt/locale/trustron_zh_CN.ts \
                src/qt/locale/trustron_zh_TW.ts
