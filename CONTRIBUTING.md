Contributing to Trustron Core
============================

The Trustron Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Trustron Core project, and is not to be
confused with overall Trustron Network Protocol consensus changes.

Whether a pull request is merged into Trustron Core rests with the project merge
...
Patches that change Trustron consensus rules are considerably more involved than
...
Where a patch set proposes to change the Trustron consensus, it must have been
...
The project leader is the release manager for each Trustron Core release.
